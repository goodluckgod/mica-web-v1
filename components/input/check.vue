<template>
  <div class="inline-flex items-center">
    <label
      class="relative flex items-center gap-3 rounded-full cursor-pointer"
      :htmlFor="random"
    >
      <input
        type="checkbox"
    ...
    <label
      class="text-xs ml-2 leading-tight font-light text-gray-500 cursor-pointer select-none"
      :for="random"
    >
      {{ label }}
    </label>
